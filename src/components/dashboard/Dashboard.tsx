...
export const Dashboard = () => {
  ...
  return (
      <div >
          ...
          <PermissionGuard allowedRoles={[RolesEnum.STAFF]}>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Sección para usuarios que pueden adoptar */}
            <PermissionGuard
              allowedRoles={[RolesEnum.STAFF, RolesEnum.USUARIO]}
            >
              <div className="bg-green-50 p-6 rounded-lg border border-green-200">
                ...
                <p className="text-green-700 mb-4">
                  Puedes ver y solicitar adopciones de mascotas
                </p>
                <button
            ...
            {/* Sección para staff que puede gestionar mascotas */}
          </div>
        </div>
