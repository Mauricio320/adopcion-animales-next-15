  ...
  useEffect(() => {
    if (animal) {
      setFormData({
        ...
        municipio_id: animal.municipio_id || "",
        sexo_id: animal.sexo_id || "",
        tamano_animal_id: animal.tamano_animal_id || "",
        tipo_edad_id: animal.tipo_edad_id || "",
        edad: animal.edad || "",
        peso: animal.peso || "",
        esta_desparasitado: animal.esta_desparasitado || false,
        esta_vacunado: animal.esta_vacunado || false,
        esta_esterilizado: animal.esta_esterilizado || false,
        es_perdido: animal.AnimalAlbergue?.es_perdido || false,
        imagen_url: animal.imagen_url || "",
      });
      setOriginalImageUrl(animal.imagen_url || "");
    }
  }, [animal]);
      ...
      <form onSubmit={handleSubmit} className="space-y-6" autoComplete="off">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:row-span-3">
            ...
            >
              Imagen de la mascota{!isEditMode ? "*" : ""}
            </label>
            <ImageUploader
        ...
        <div className="flex justify-center pt-6">
          <button
            type="submit"
            disabled={isSubmitting || (!isEditMode && !imgFile)}
